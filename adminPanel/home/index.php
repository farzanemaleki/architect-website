<?php include('../layout/header-style.php') ?>
<body>
<!-- Sidenav -->
<?php include('../layout/sidenav/sidenav.php') ?>

<div class="main-content">
    <!-- Main content -->
    <!-- Top navbar -->
    <?php include('../layout/topNavbar/topNavbar.php') ?>
    <!-- Header -->
...
<?php include('../layout/footer-scripts.php') ?>
