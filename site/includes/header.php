...
<div class="menu">
    ...
    <div class="menu-footer right-boxed">
        ...
        <div class="copy">© Bauhaus 2017. All Rights Reseverd<br> Design by RegulusCoder</div>
    </div>
</div>
...
<header class="navbar boxed js-navbar">
    ...
    <a class="brand" href="#">
        <img alt="" src="<?php echo SITEURL ?>site/assets/images/brand-dark.png">
    ...
    <div class="dark-mode">
        <div class="mode-btn">
            <input type="checkbox" name="check" id="check" hidden checked>
            <label for="check">
                <div class="box">
                    ...
                    <div class="scenary">
                        ...
                        <div class="moon">
                            ...
                            <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
                                ...
                                <path style="fill:#c0a22c;" d="M146.88,375.528c126.272,0,228.624-102.368,228.624-228.64c0-55.952-20.16-107.136-53.52-146.88
