        ...
        <div id="rev_slider" class="rev_slider tp-overflow-hidden fullscreenbanner">
            <ul>
                ...
                <li data-transition='slideleft' data-slotamount='default' data-masterspeed="1000"
                    ...
                    <img src="<?php echo SITEURL ?>site/assets/images/slider/slide1.jpg" data-bgparallax="5" alt=""
                ...
                <li data-transition='slideleft' data-slotamount='default' data-masterspeed="1000"
                    ...
                    <img src="<?php echo SITEURL ?>site/assets/images/slider/slide2.jpg" data-bgparallax="5" alt=""
                        data-bgposition="center 0" data-bgfit="cover" data-bgrepeat="no-repeat"
                        class="rev-slidebg">
                ...
                <li data-transition='slideleft' data-slotamount='default' data-masterspeed="1000"
                    ...
                    <img src="<?php echo SITEURL ?>site/assets/images/slider/slide3.jpg" data-bgparallax="5" alt=""
                        data-bgposition="center 0" data-bgfit="cover" data-bgrepeat="no-repeat"
                        class="rev-slidebg">
...
<div class="content">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <h2 class="section-title section-about-title">We Are The Leader In The Architectural
                    </h2>
                ...
                <div class="col-md-5 col-md-offset-1">
                    <div class="dots-image">
                        <img alt="" class="about-img img-responsive" src="<?php echo SITEURL ?>site/assets/images/1-470x660.jpg">
                        <div class="dots"></div>
                    </div>
                </div>
            </div>
    ...
    <section class="section-projects section">
        ...
        <div class="project-carousel owl-carousel">
            <div class="project-item item-shadow building">
                <img alt="" class="img-responsive" src="<?php echo SITEURL ?>site/assets/images/projects/1-426x574.jpg">
                <div class="project-hover">
                    <div class="project-hover-content">
                        ...
                        <p class="project-description">Lorem ipsum dolor sit amet, consectetur adipil pcing
                            elit. Proin nunc leo, rhoncus sit amet tolil arcu vel, pharetra volutpat sem
                            lorn Donec tincidunt velit nec laoreet semper...</p>
                    </div>
                </div>
                <a href="" class="link-arrow">See project <i class="icon ion-ios-arrow-right"></i></a>
            </div>
            <div class="project-item item-shadow building">
                <img alt="" class="img-responsive" src="<?php echo SITEURL ?>site/assets/images/projects/2-426x574.jpg">
                <div class="project-hover">
                    <div class="project-hover-content">
            ...
            <div class="project-item item-shadow building">
                <img alt="" class="img-responsive" src="<?php echo SITEURL ?>site/assets/images/projects/3-426x574.jpg">
                <div class="project-hover">
                    <div class="project-hover-content">
            ...
            <div class="project-item item-shadow building">
                <img alt="" class="img-responsive" src="<?php echo SITEURL ?>site/assets/images/projects/4-426x574.jpg">
                <div class="project-hover">
                    <div class="project-hover-content">
            ...
            <div class="project-item item-shadow interior-exterior">
                <img alt="" class="img-responsive" src="<?php echo SITEURL ?>site/assets/images/projects/5-426x574.jpg">
                <div class="project-hover">
                    <div class="project-hover-content">
            ...
            <div class="project-item item-shadow interior-exterior">
                <img alt="" class="img-responsive" src="<?php echo SITEURL ?>site/assets/images/projects/6-426x574.jpg">
                <div class="project-hover">
                    <div class="project-hover-content">
            ...
            <div class="project-item item-shadow interior-exterior">
                <img alt="" class="img-responsive" src="<?php echo SITEURL ?>site/assets/images/projects/7-426x574.jpg">
                <div class="project-hover">
                    <div class="project-hover-content">
            ...
            <div class="project-item item-shadow interior-exterior">
                <img alt="" class="img-responsive" src="<?php echo SITEURL ?>site/assets/images/projects/8-426x574.jpg">
                <div class="project-hover">
                    <div class="project-hover-content">
    ...
    <section class="section-clients section bg-dots">
        <div class="container">
            <h2 class="section-title">Our Partners Brands</h2>
            <div class="partner-carousel owl-carousel">
                <div class="partner-carousel-item">
                    <img alt="" src="<?php echo SITEURL ?>site/assets/images/partners/partners-logo-dark/1.png">
                </div>
                <div class="partner-carousel-item">
                    <img alt="" src="<?php echo SITEURL ?>site/assets/images/partners/partners-logo-dark/2.png">
                </div>
                <div class="partner-carousel-item">
                    <img alt="" src="<?php echo SITEURL ?>site/assets/images/partners/partners-logo-dark/3.png">
                </div>
                <div class="partner-carousel-item">
                    <img alt="" src="<?php echo SITEURL ?>site/assets/images/partners/partners-logo-dark/2.png">
                </div>
                ...
                <div class="partner-carousel-item">
                    <img alt="" src="<?php echo SITEURL ?>site/assets/images/partners/partners-logo-dark/4.png">
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="section-news section">
        <div class="container">
            ...
            <div class="news-carousel owl-carousel">
                ...
                <div class="news-item">
                    <img alt="" src="<?php echo SITEURL ?>site/assets/images/blogs/2-370x370.jpg">
                    <div class="news-hover">
                        <div class="hover-border">
                            <div></div>
                        </div>
                ...
                <div class="news-item">
                    <img alt="" src="<?php echo SITEURL ?>site/assets/images/blogs/3-370x370.jpg">
                    <div class="news-hover">
                        <div class="hover-border">
                            <div></div>
                        </div>
