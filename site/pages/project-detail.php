                ...
                <div id="rev_slider2" class="rev_slider tp-overflow-hidden fullscreenbanner">
                    <ul>
                        ...
                        <li data-transition="slideleft" data-masterspeed="1200" data-fsmasterspeed="1200">
                            ...
                            <img src=<?= SITEURL."site/assets/images/projects/1-1920x1080.jpg" ?> alt="" data-bgposition="center center"
                                data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg">

                            <div class="tp-caption tp-shape tp-shapewrapper rs-toggle-content-active" data-x="['left']" data-hoffset="['0']"
                                data-y="['top']" data-voffset="['50','50','40','40']" data-width="528" data-minwidth="528"
                                ...
                                <div class="project-detail-info">
                                    <div class="project-detail-control active"><span class="hide-info">hide information</span><span
                                            class="show-info">show information</span></div>
                                    <div class="project-detail-content" > 
                                        <h3 class="project-detail-title">The Luxury Residence<br> In Forest</h3>
                                        <p class="project-detail-text">Lorem ipsum dolor sit amet, consectetuer adipiscing
                                            elit, sed diam nonummy nibh euismod tincidunt ut. magna aliquam erat volutpat
                                            enim ad minim veniam. Duis autem vel eum iriure dolor in hendrerit in.</p>
                        ...
                        <li data-transition="slideleft" data-masterspeed="1200" data-fsmasterspeed="1200">
                            ...
                            <img src=<?= SITEURL."site/assets/images/projects/2-1920x1080.jpg" ?> alt="" data-bgposition="center center"
                                data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg">
                            ...
                            <div class="tp-caption tp-shape tp-shapewrapper rs-toggle-content-active" data-x="['left']" data-hoffset="['0']"
                                ...
                                <div class="project-detail-info">
                                    <div class="project-detail-control active"><span class="hide-info">hide information</span><span
                                            class="show-info">show information</span></div>
                                    <div class="project-detail-content">
                                        <h3 class="project-detail-title">Small House Near<br>Wroclaw</h3>
                                        <p class="project-detail-text">Lorem ipsum dolor sit amet, consectetuer adipiscing
                                            elit, sed diam nonummy nibh euismod tincidunt ut. magna aliquam erat volutpat
                                            enim ad minim veniam. Duis autem vel eum iriure dolor in hendrerit in.</p>
                                        <ul class="project-detail-list text-dark">
                        ...
                        <li data-transition="slideleft" data-masterspeed="1200" data-fsmasterspeed="1200">
                            ...
                            <img src=<?= SITEURL."site/assets/images/projects/3-1920x1080.jpg" ?> alt="" data-bgposition="center center"
                                data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg">
