<?php require_once '../layouts/headerLayout.php' ?>
    <main class="page-header">
        <div class="container">
            <h1>Latest Thoughts, Ideas & Plans.</h1>
        </div>
    </main>
    <div class="content">
        <div class="projects">
            <div class="container">
                ...
                <div class="grid-items js-isotope js-grid-items">
                    ...
                    <div class="grid-item architecture-inteior js-isotope-item js-grid-item">
                        <div class="news-item">
                            <img alt="" src="<?php echo SITEURL ?>site/assets/images/blogs/4-370x370.jpg">
                            <div class="news-hover">
                                <div class="hover-border">
                                    <div></div>
                                </div>
                    ...
                    <div class="grid-item decoration js-isotope-item js-grid-item">
                        <div class="news-item">
                            <img alt="" src="<?php echo SITEURL ?>site/assets/images/blogs/5-370x370.jpg">
                            <div class="news-hover">
                                <div class="hover-border">
                                    <div></div>
                                </div>
                    ...
                    <div class="grid-item decoration js-isotope-item js-grid-item">
                        <div class="news-item">
                            <img alt="" src="<?php echo SITEURL ?>site/assets/images/blogs/6-370x370.jpg">
                            <div class="news-hover">
                                <div class="hover-border">
                                    <div></div>
                                </div>
                    ...
                    <div class="grid-item plants js-isotope-item js-grid-item">
                        <div class="news-item">
                            <img alt="" src="<?php echo SITEURL ?>site/assets/images/blogs/7-370x370.jpg">
                            <div class="news-hover">
                                <div class="hover-border">
                                    <div></div>
                                </div>
                    ...
                    <div class="grid-item plants js-isotope-item js-grid-item">
                        <div class="news-item">
                            <img alt="" src="<?php echo SITEURL ?>site/assets/images/blogs/8-370x370.jpg">
                            <div class="news-hover">
                                <div class="hover-border">
                                    <div></div>
                                </div>
                    ...
                    <div class="grid-item plants js-isotope-item js-grid-item">
                        <div class="news-item">
                            <img alt="" src="<?php echo SITEURL ?>site/assets/images/blogs/9-370x370.jpg">
                            <div class="news-hover">
                                <div class="hover-border">
                                    <div></div>
                                </div>
