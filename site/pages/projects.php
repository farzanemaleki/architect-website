            ...
            <div class="grid-items js-isotope js-grid-items">
                <div class="grid-item building js-isotope-item js-grid-item">
                    <div class="project-item item-shadow">
                        <img alt="" class="img-responsive" src=<?=SITEURL . "site/assets/images/projects/1-426x574.jpg"?> >
                        <div class="project-hover">
                            <div class="project-hover-content">
                                ...
                                <p class="project-description">Lorem ipsum dolor sit amet, consectetur adipil
                                    pcing elit. Proin nunc leo, rhoncus sit amet tolil arcu vel, pharetra
                                    volutpat sem lorn Donec tincidunt velit nec laoreet semper...</p>
                            </div>
                        </div>
                ...
                <div class="grid-item building js-isotope-item js-grid-item">
                    <div class="project-item item-shadow">
                        <img alt="" class="img-responsive" src= <?=SITEURL . "site/assets/images/projects/2-426x574.jpg"?> >
                        <div class="project-hover">
                            <div class="project-hover-content">
                ...
                <div class="grid-item villa js-isotope-item js-grid-item">
                    <div class="project-item item-shadow">
                        <img alt="" class="img-responsive" src=<?=SITEURL . "site/assets/images/projects/3-426x574.jpg"?>>
                        <div class="project-hover">
                            <div class="project-hover-content">
                ...
                <div class="grid-item villa js-isotope-item js-grid-item">
                    <div class="project-item item-shadow">
                        <img alt="" class="img-responsive" src=<?=SITEURL . "site/assets/images/projects/4-426x574.jpg"?>>
                        <div class="project-hover">
                            <div class="project-hover-content">
                ...
                <div class="grid-item interior js-isotope-item js-grid-item">
                    <div class="project-item item-shadow">
                        <img alt="" class="img-responsive" src=<?=SITEURL . "site/assets/images/projects/5-426x574.jpg"?>>
                        <div class="project-hover">
                            <div class="project-hover-content">
                ...
                <div class="grid-item interior js-isotope-item js-grid-item">
                    <div class="project-item item-shadow">
                        <img alt="" class="img-responsive" src=<?=SITEURL . "site/assets/images/projects/6-426x574.jpg"?>>
                        <div class="project-hover">
                            <div class="project-hover-content">
                ...
                <div class="grid-item exterior js-isotope-item js-grid-item">
                    <div class="project-item item-shadow">
                        <img alt="" class="img-responsive" src=<?=SITEURL . "site/assets/images/projects/7-426x574.jpg"?>>
                        <div class="project-hover">
                            <div class="project-hover-content">
                ...
                <div class="grid-item exterior js-isotope-item js-grid-item">
                    <div class="project-item item-shadow">
                        <img alt="" class="img-responsive" src=<?=SITEURL . "site/assets/images/projects/8-426x574.jpg"?>>
                        <div class="project-hover">
                            <div class="project-hover-content">
